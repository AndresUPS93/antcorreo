  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_mail" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_mail_form();
	}

  // ---------- Validate destinatario
  function do_ajax_control_mail_validate_destinatario()
  {
    var nomeCampo_destinatario = "destinatario";
    var var_destinatario = scAjaxGetFieldText(nomeCampo_destinatario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_mail_validate_destinatario(var_destinatario, var_script_case_init, do_ajax_control_mail_validate_destinatario_cb);
  } // do_ajax_control_mail_validate_destinatario

  function do_ajax_control_mail_validate_destinatario_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_mail_validate_destinatario_cb

  // ---------- Validate correo
  function do_ajax_control_mail_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_mail_validate_correo(var_correo, var_script_case_init, do_ajax_control_mail_validate_correo_cb);
  } // do_ajax_control_mail_validate_correo

  function do_ajax_control_mail_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_mail_validate_correo_cb

  // ---------- Validate asunto
  function do_ajax_control_mail_validate_asunto()
  {
    var nomeCampo_asunto = "asunto";
    var var_asunto = scAjaxGetFieldText(nomeCampo_asunto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_mail_validate_asunto(var_asunto, var_script_case_init, do_ajax_control_mail_validate_asunto_cb);
  } // do_ajax_control_mail_validate_asunto

  function do_ajax_control_mail_validate_asunto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asunto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_mail_validate_asunto_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_mail_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_mail_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_mail_submit_form(var_destinatario, var_correo, var_asunto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_mail_submit_form_cb);
  } // do_ajax_control_mail_submit_form

  function do_ajax_control_mail_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_mail_submit_form_cb_after_alert);
  } // do_ajax_control_mail_submit_form_cb
  function do_ajax_control_mail_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_mail_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_mail_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_mail_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_mail']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_mail_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_mail_navigate_form_cb_after_alert);
  } // do_ajax_control_mail_navigate_form_cb
  function do_ajax_control_mail_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_mail_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_mail_navigate_form_cb_after_alert
  function sc_hide_control_mail_form()
  {
